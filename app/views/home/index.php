        ...
        <div class="row">
          <div class="container">
            <div class="col-md-3 text-right">
              <img style="max-width: 200px;"  class="animated zoomInLeft" src="http://s20.postimg.org/pfmmo6qj1/window_domain.png">
            </div>
        ...
        <div class="row">
          <div class="container">
            ...
            <div class="col-md-5 text-right">
              <img style="max-width: 200px;"  class="animated zoomInLeft" src="http://s20.postimg.org/sp11uneml/rack_server_unlock.png">
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="item">
        <div class="row">
          <div class="container">
            ...
            <div class="col-md-5 text-right">
              <img style="max-width: 200px;"  class="animated zoomInLeft" src="http://s20.postimg.org/eq8xvxeq5/globe_network.png">
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="item">
        <div class="row">
          <div class="container">
            ...
            <div class="col-md-5 text-right">
              <img style="max-width: 200px;"  class="animated zoomInLeft" src="http://s20.postimg.org/9vf8xngel/internet_speed.png">
            </div>
          </div>
        </div>
      </div>
