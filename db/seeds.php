...
if (User::load()->count() == 0) {
  ...
  User::create(["first_name" => "Ramazan", "last_name" => "İhsanoğlu", "username" => "rihsanoglu", "password" => "123456", "boss" => true, "admin" => false]);
  User::create(["first_name" => "Sedat",  "last_name" => "Göksel", "username" => "sgoksel", "password" => "123456", "boss" => false, "admin" => true]);
